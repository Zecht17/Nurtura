...
export default function AddTaskScreen() {
    ...
    const handleManualDateInput = (text: string) => {
        ...
        if (match) {
            const date = new Date(match[3], parseInt(match[1]) - 1, match[2]);
            setDueDate(date);
        }
    };
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.formContainer}>
                            <View style={styles.formContent}>
                                ...
                                {/* Task Input */}
                                <Text style={styles.inputTitle2}>Task Title</Text>
                                <TextInput 
                                    // label="Task Title" 
                                    autoCapitalize="none" keyboardType="default" placeholder="Enter task title" mode="outlined"  activeOutlineColor="#6d28d9" outlineStyle={{ borderRadius: 12, borderWidth: 1.5 }} style={[styles.input, styles.inputField]}/>

                                {/* Task Description */}
                                <Text style={styles.inputTitle2}>Task Description</Text>
                                <TextInput 
                                ...
                                <View style={styles.inputRow}>
                                    <View style={styles.inputGroup}>
                                        {/* Due Date */}
                                        <Text style={styles.inputTitle2}>Due Date</Text>
                                    ...
                                    <View style={styles.inputGroup}>
                                        {/* Due Time */}
                                        <Text style={styles.inputTitle2}>Time</Text>
                                        <View style={styles.datePickerContainer}>
                                            {Platform.OS !== 'web' ? (
                                ...
                                <View style={styles.recurringTaskRow}>
                                    <View style={styles.recurringTaskWrapper}>
                                        <Text style={styles.inputTitle}>Recurring Task</Text>
