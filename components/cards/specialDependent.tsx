...
import SpecialNeedsTypeTag from '@/components/tags/type/specialNeeds';
import Ionicons from '@expo/vector-icons/Ionicons';
import MaterialCommunityIcons from '@expo/vector-icons/MaterialCommunityIcons';
import React from 'react';
import { Pressable, StyleSheet, Text, View } from 'react-native';

type SpecialDependentCardProps = {
    name: string;
    age: number;
    birthday: string;
    careNotes: string;
...
export default function SpecialDependentCard({
    name,
    age,
    birthday,
    careNotes,
    ...
    onEdit,
    onDelete,
}: SpecialDependentCardProps) {
    return (
        <View style={styles.dependentContainer}>
            <View style={styles.profileRow}>
                <View style={styles.iconBg}>
                    <MaterialCommunityIcons name="wheelchair-accessibility" size={33} color="white" />
                </View>
