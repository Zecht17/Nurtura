...
import GeneralTypeTag from '@/components/tags/type/general';
...
type GeneralDependentCardProps = {
    name: string;
    age: number;
    birthday: string;
    careNotes: string;
...
export default function GeneralDependentCard({
    name,
    age,
    birthday,
    careNotes,
